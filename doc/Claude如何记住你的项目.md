...
2. Deploy with your configuration management system (MDM, Group Policy, Ansible, or similar). See [managed settings](https://code.claude.com/docs/en/permissions#managed-settings) for other organization-wide configuration options.
